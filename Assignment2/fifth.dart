...
void main() {
  MaximumSumPath sumpath = MaximumSumPath();
  List<int> ar1 = [2, 3, 7, 10, 12];
  List<int> ar2 = [1, 5, 7, 8];
  int m = ar1.length;
  int n = ar2.length;

  // Function call
  print("Maximum sum path is : ${sumpath.maxPathSum(ar1, ar2, m, n)}");
}
...
class MaximumSumPath {
  ...
  int maxPathSum(List<int> ar1, List<int> ar2, int m, int n) {
